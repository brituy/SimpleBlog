...
use Brituy\SimpleBlog\Model\ResourceModel\Category\Collection;
use Brituy\SimpleBlog\Model\ResourceModel\Category\CollectionFactory as BlogCategoryCollectionFactory;
...
class Category extends Multiselect
{
    ...
    public function getCategoryCollection()
    {
        ...
        foreach ($collection as $category) {
            $categoryById[$category->getId()]['value'] = $category->getCategoryId();
    ...
    public function getAfterElementHtml()
    {
        $html = '<script type="text/x-magento-init">
                                ...
                                "children": {
                                    "blog_select_category": {
                                        ...
                                        "config": {
                                            ...
                                            "options": ' . json_encode($this->getCategoryCollection()) . ',
            ...
            $this->_urlBuilder->getUrl(
                ...
                ['handle' => 'brituy_simpleblog_category_create', 'buttons' => 1]
            ) . '",
                                        "autoRender": false,
