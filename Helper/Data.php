...
namespace Brituy\SimpleBlog\Helper;
...
use Brituy\SimpleBlog\Model\Category;
use Brituy\SimpleBlog\Model\CategoryFactory;
use Brituy\SimpleBlog\Model\Config\Source\SideBarLR;
use Brituy\SimpleBlog\Model\Post;
use Brituy\SimpleBlog\Model\PostFactory;
use Brituy\SimpleBlog\Model\ResourceModel\Author\Collection as AuthorCollection;
use Brituy\SimpleBlog\Model\ResourceModel\Category\Collection as CategoryCollection;
use Brituy\SimpleBlog\Model\ResourceModel\Post\Collection as PostCollection;
use Brituy\SimpleBlog\Helper\AbstractData as CoreHelper;

/** Class Data
  * @package Brituy\Blog\Helper */
class Data extends CoreHelper
{
    const CONFIG_MODULE_PATH = 'simpleblog';
    ...
    public function getPostList($storeId = null)
    {
        ...
        $collection = $this->getObjectList(self::TYPE_POST, $storeId)
            ->addFieldToFilter('blog_date', ['to' => $this->dateTime->date()])
            ->setOrder('blog_date', 'desc');
     ...
     * @param null $type
     * @param null $storeId
     * @return AuthorCollection|CategoryCollection|PostCollection|Collection
     * @throws NoSuchEntityException
     */
    public function getObjectList($type = null, $storeId = null)
    {
        /** @var AuthorCollection|CategoryCollection|PostCollection|Collection $collection */
    ...
    /** @param $type
      * @return AuthorFactory|CategoryFactory|PostFactory */
